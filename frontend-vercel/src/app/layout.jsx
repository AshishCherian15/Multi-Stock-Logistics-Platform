...
export const metadata = {
  title: 'MultiStock - Enterprise Inventory Management',
  description: 'Enterprise-grade inventory management and marketplace platform',
};
          ...
          <div className="container">
            ...
            <div className="collapse navbar-collapse" id="guestNav">
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li className="nav-item">
                  <a className="nav-link" href="/rentals">
                    <i className="fas fa-key me-1"></i> Rentals
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" href="/storage">
                    <i className="fas fa-warehouse me-1"></i> Storage
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" href="/lockers">
                    <i className="fas fa-box me-1"></i> Lockers
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" href="#">
                    <i className="fas fa-comments me-1"></i> Forums
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" href="#">
              ...
              <div className="d-flex gap-2 align-items-center">
                <a href="#" className="btn btn-guest-register">
                  <i className="fas fa-user-plus me-1"></i> Register
                </a>
                <a href="#" className="btn btn-guest-login">
                  <i className="fas fa-sign-in-alt me-1"></i> Login
                </a>
                <a href="/" className="btn btn-exit-guest">
            ...
            <div className="row">
              ...
              <div className="col-md-3 mb-4">
                ...
                <ul className="list-unstyled">
                  ...
                  <li className="mb-2"><a href="#"><i className="fas fa-sign-in-alt me-2"></i>Login</a></li>
